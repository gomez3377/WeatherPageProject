...
function kelvinToFahrenheit (K) {
  ...
  const prestonTownEventsjQuery = 'https://byui-cit230.github.io/weather/data/towndata.json';
  fetch(prestonTownEventsjQuery)
  ...
  .then(function(jsonObject){
    ...
    townEvent1.textContent = jsonObject.towns[6].events[0];
    townEvent2.textContent = jsonObject.towns[6].events[1];
    townEvent3.textContent = jsonObject.towns[6].events[2];
